 ...
 */
var ENV = 'build'; //process.env.npm_lifecycle_event;
...
module.exports = function makeWebpackConfig() {
  ...
  config.module = {
    ...
    loaders: [
      // Support for .ts files.
      {
        ...
        exclude: [isTest ? /\.(e2e)\.ts$/ : /\.(spec|e2e)\.ts$/, /^(emails)\/.*/, /node_modules\/(?!(ng2-.+))/]
      },
   ...
   * Transforms .sass files to .css
   */
  config.sassLoader = {
    //includePaths: [path.resolve(__dirname, "node_modules/foundation-sites/sass")]
  };
